  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-6">
        ...
        {/* SQL Code Block */}
        <textarea
          value={sqlCode} // Use value here for controlled component
          onChange={handleSqlChange} // Handle change event
          rows={10}
      ...
      <div className="mt-6">
        ...
        <textarea
          value={convCode} // Use value here for controlled component
          onChange={handleConvCodeChange} // Handle change event
          rows={10}
          className="bg-gray-800 text-white p-4 mt-2 w-full rounded-lg"
        />
      </div>
